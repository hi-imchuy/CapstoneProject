...
const INVALID_UPDATE_FIELDS = ['_id', 'email', 'username', 'createdAt', 'role']
...
const createNew = async (data) => {
  try {
    ...
    const createdUser = await GET_DB().collection(USER_COLLECTION_NAME).findOne({ _id: result.insertedId })
    return createdUser
  } catch (error) {
