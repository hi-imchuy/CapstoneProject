...
function Notifications() {
  ...
  useEffect(() => {
    ...
    //Tạo fuction xử lí khi nhận được sự kiện real-time:
    //https://socket.io/how-to/use-with-react
    const onReceiveNewInvitation = (invitation) => {
      //Nếu user đang đăng nhập hiện tại mà ta đang lưu trong redux chính là invitee trong bảng ghi invitation
      if (invitation.inviteeId === currentUser._id) {
        //Bước 1: Thêm bảng ghi invitation vào Redux
    ...
    //Clean up sự kiện để ngăn chặn việc bị đăng kí lặp lại event
    return () => {
  ...
  //Update new status của 1 lời mời join board
