...
function ActiveCard() {
  ...
  //Function call API dùng chung cho các trường hợp update card title, description, cover, comment, ...
  const callApiUpdateCard = async (updateData) => {
    const updatedCard = await updateCardDetailsAPI(activeCard._id, updateData)

    //B1: Cập nhật card đang active trong modal hiện tại
    dispatch(updateCurrentActiveCard(updatedCard))

    //B2: Cập nhật bảng ghi card trong activeBoard (nested data)
