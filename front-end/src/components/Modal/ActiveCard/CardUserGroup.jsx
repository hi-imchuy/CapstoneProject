...
function CardUserGroup({ cardMemberIds = [], onUpdateCardMembers }) {
  ...
  // Lấy activeBoard từ Redux ra để mục đích là lấy được toàn bộ thông tin những thành viên của board
  // thông qua field: FE_allUser
  ...
  const handleUpdateCardMemebers = (user) => {
    // console.log('🚀 ~ handleUpdateCardMemebers ~ user:', user)
    const incomingMemberInfo = {
      //Tạo biến incomingMemberInfo để gửi cho BE với 2 tt là userId và action (xóa hoặc thêm vào card)
      userId: user._id,
